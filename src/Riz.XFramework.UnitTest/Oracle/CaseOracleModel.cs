...
{
    public class CaseOracleModel
    {
        [Table(Name = "sys_demo")]
        public class CaseOracleDemo : OracleModel.OracleDemo
        {
            public CaseOracleDemo()
                : base()
            {
            }

            public CaseOracleDemo(int demoId, string demoName)
                : base(demoId, demoName)
            {

            }

            public CaseOracleDemo(OracleDemo model)
                : base(model)
            {
