...
CREATE TABLE "bas_clientaccount_s"(
...
CREATE TABLE "bas_clientaccountmarket_s"(
  "clientid" int NOT NULL,
  "accountid" nvarchar2(100) NOT NULL,
...
CREATE TABLE "sys_cloudserver_s"(
...
DROP SEQUENCE "sys_demo_demoid_seq_s";
CREATE SEQUENCE "sys_demo_demoid_seq_s" INCREMENT BY 1;
COMMIT;

TRUNCATE TABLE "bas_client_s";
TRUNCATE TABLE "bas_clientaccount_s";
TRUNCATE TABLE "bas_clientaccountmarket_s";
TRUNCATE TABLE "sys_cloudserver_s";
COMMIT;
...
BEGIN
    ...
    Delete FROM "sys_cloudserver_s";
    Insert Into "sys_cloudserver_s" ("cloudserverid","cloudservercode","cloudservername") Values (1,'0181',N'181服务器');
    Insert Into "sys_cloudserver_s" ("cloudserverid","cloudservercode","cloudservername") Values (2,'0182',N'182服务器');
    Insert Into "sys_cloudserver_s" ("cloudserverid","cloudservercode","cloudservername") Values (3,'0183',N'183服务器');      
   
  WHILE (rowIndex <= 100) LOOP
      
  
      nextVal_ := "sys_demo_demoid_seq_s".nextval;
      insert into "sys_demo_s"
          ("demoid"
          ,"democode"
          ,"demoname"
          ,"demoboolean"
    ...
    INSERT INTO "bas_clientaccount_s"
        ("clientid"
        ,"accountid"
        ,"accountcode"
        ,"accountname"
    ...
    INSERT INTO "bas_clientaccountmarket_s"
        ("clientid"
        ,"accountid"
        ,"marketid"
        ,"marketcode"
