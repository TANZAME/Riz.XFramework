    ...
    public abstract class TestBase_NA<TDemo> : ITest where TDemo : Model_NA.Demo, new()
    {
        ...
        protected virtual void Query()
        {
            ...
            var dynamicQuery =
                ...
                select new
                {
                    ...
                    DemoGuid = guid,
                    DemoEnum = Model_NA.State.Complete,
                    DemoEnum2 = Model_NA.State.Executing,
                };
            ...
            query = context
                ...
                .Select(a => new TDemo
                {
                    ...
                    RizDemoCode = Data.DbFunctions.CaseWhen(a.RizDemoName == "张1", "李1").When(a.RizDemoName == "张2", "李2").Else("李李"), //a.DemoName == "张三" ? "李四" : "王五",
            ...
            int m_byte = 16;
            Model_NA.State state = Model_NA.State.Complete;
            ...
            query = context.GetTable<TDemo>().Where(a =>
                        ...
                        a.RizDemoByte == (byte)Model_NA.State.Complete ||
                        a.RizDemoInt == (int)Model_NA.State.Complete ||
            ...
            var query1 =
                ...
                .Select(a => new
                {
                    RowNumber = Data.DbFunctions.RowNumber(a.RizDemoCode)
                });
            ...
            var query2 =
                ...
                .Select(a => new
                {
                    RowNumber = Data.DbFunctions.RowNumber<long, string>(a.RizDemoCode, OrderBy.DESC)
                });
            var result2_0 = query2.ToList();

            query1 =
            context
            .GetTable<Model_NA.Account>()
            .Select(a => new
            {
                RowNumber = Data.DbFunctions.PartitionRowNumber(a.RizClientId, a.RizAccountId)
            });
            ...
            .GetTable<Model_NA.Account>()
                .Select(a => new
                {
                    RowNumber = Data.DbFunctions.PartitionRowNumber<long, int, string>(a.RizClientId, a.RizAccountId, OrderBy.DESC)
                });
        ...
        protected virtual void DbFunction()
        {
            ...
            var query2 =
                ...
                .Select(a => new
                {
                    DemoId = a.RizDemoId,
                    Mod = a.RizDemoId % 2,
                    Divide = Data.DbFunctions.Cast<int, decimal>(a.RizDemoId, "decimal") / 2,
        ...
        protected virtual void Join()
        {
            ...
            var query =
                ...
                join b in context.GetTable<Model_NA.Server>() on a.RizCloudServerId equals b.RizCloudServerId
                where a.RizClientId > 0
                select a;
            var result = query.ToList();
            query = from a in context.GetTable<Model_NA.Client>()
                    join b in context.GetTable<Model_NA.Server>() on a.RizCloudServerId equals b.RizCloudServerId
                    select a;
            result = query.ToList();
            // 点标记
            query = context
                ...
                .Join(context.GetTable<Model_NA.Server>(), a => a.RizCloudServerId, b => b.RizCloudServerId, (a, b) => a);
            query = query.Where(a => a.RizClientId > 0);
            query = query.Where<Model_NA.Client, Model_NA.Server>((a, b) => a.RizClientId > 0 && b.RizCloudServerName != null);
            query = query.Select<Model_NA.Client, Model_NA.Server, Model_NA.Client>((a, b) => new Model_NA.Client
            {
            ...
            query =
                from a in context.GetTable<Model_NA.Client>()
                join b in context.GetTable<Model_NA.Client, Model_NA.Server>(a => a.CloudServer) on a.RizCloudServerId equals b.RizCloudServerId
                where a.RizClientId > 0
                select a;
            result = query.ToList();
            //SQL=>
            ...
            query =
                from a in context.GetTable<Model_NA.Client>()
                select new Model_NA.Client(a)
                {
                    CloudServer = a.CloudServer,
                    LocalServer = new Model_NA.Server
                    {
            ...
            query = context.GetTable<Model_NA.Client>()
            ...
            query =
                context
                .GetTable<Model_NA.Client>()
                .Include(a => a.CloudServer, a => new Model_NA.Server
                {
                    RizCloudServerId = a.RizCloudServerId,
            ...
            query =
                ...
                .Include(a => a.Accounts, a => new Model_NA.Account
                {
            ...
            var query3 =
                from a in context.GetTable<Model_NA.Client>()
                join b in context.GetTable<Model_NA.Account>() on a.RizClientId equals b.RizClientId
            ...
            var query4 =
                ...
                .SelectMany(a => context.GetTable<Model_NA.Client>(), (a, b) => new
                {
            ...
            query =
                  from a in context.GetTable<Model_NA.Client>()
                  join b in context.GetTable<Model_NA.Server>() on a.RizCloudServerId equals b.RizCloudServerId into u_b
            ...
            query =
                  from a in context.GetTable<Model_NA.Client>()
                  join b in context.GetTable<Model_NA.Server>() on new { a.RizCloudServerId, RizCloudServerCode = "567" } equals new { b.RizCloudServerId, b.RizCloudServerCode } into u_b
                  from b in u_b.DefaultIfEmpty()
                  select a;
            query = query.Where(a => a.CloudServer.RizCloudServerName != null);
            result = query.ToList();
            ...
            query =
                 from a in context.GetTable<Model_NA.Client>()
                 join b in context.GetTable<Model_NA.Server>() on a.RizCloudServerId equals b.RizCloudServerId into u_c
                 from b in u_c.DefaultIfEmpty()
                 select a;
            var query5 =
                query.SelectMany(c => context.GetTable<Model_NA.Server>(), (a, c) => new
                {
                    ClientId = a.RizClientId,
            ...
            if (_databaseType != DatabaseType.SQLite)
            {
                // RIGHT JOIN
                query =
                      from a in context.GetTable<Model_NA.Server>()
                      join b in context.GetTable<Model_NA.Client>() on a.RizCloudServerId equals b.RizCloudServerId into u_b
            ...
            var q1 = context.GetTable<Model_NA.Client>().Where(x => x.RizClientId <= 10);
            var q2 = context.GetTable<Model_NA.Client>().Where(x => x.RizClientId <= 10);
            var q3 = context.GetTable<Model_NA.Client>().Where(x => x.RizClientId <= 10);
            ...
            // UNION 注意UNION分页的写法，仅支持写在最后
            var q4 = context.GetTable<Model_NA.Client>().Where(x => x.RizClientId <= 10).AsSubquery();//.OrderBy(x => x.RizClientName)
            var q5 = context.GetTable<Model_NA.Client>().Where(x => x.RizClientId <= 10 && x.Accounts[0].RizAccountId != null).OrderBy(x => x.CloudServer.RizCloudServerId).Skip(5).AsSubquery();
            var q6 = context.GetTable<Model_NA.Client>().Where(x => x.RizClientId <= 10 && x.Accounts[0].RizAccountId != null).OrderBy(x => x.CloudServer.RizCloudServerId).Skip(1).Take(2).AsSubquery();
            ...
            // Any
            var isAny = context.GetTable<Model_NA.Client>().Any();
            isAny = context.GetTable<Model_NA.Client>().Any(a => a.RizActiveDate == DateTime.Now);
            isAny = context.GetTable<Model_NA.Client>().Distinct().Any(a => a.RizActiveDate == DateTime.Now);
            isAny = context.GetTable<Model_NA.Client>().OrderBy(a => a.RizClientId).Skip(2).Take(5).Any(a => a.RizActiveDate == DateTime.Now);
            //SQL=> 
            //IF EXISTS(
            //    SELECT TOP 1 1
            //    FROM[Bas_Client] t0
            ...
            // FirstOrDefault
            var f = context.GetTable<Model_NA.Client>().FirstOrDefault();
            //SQL=> 
            //SELECT TOP(1)
            //t0.[RizClientId] AS[RizClientId],
            //t0.[RizClientCode] AS[RizClientCode],
            ...
            var max = context.GetTable<Model_NA.Client>().Where(a => a.RizClientId < -9).Max(a => a.RizClientId);
            //SQL=> 
            //SELECT
            //MAX(t0.[RizClientId])
            //FROM[Bas_Client] t0
            ...
            query7 =
                 from a in context.GetTable<Model_NA.Client>()
                 where a.RizClientName == "TAN"
                 group a by new Model_NA.Client { RizClientId = a.RizClientId, RizClientName = a.RizClientName } into g
                 where g.Key.RizClientId > 0
                 orderby g.Key.RizClientName
                 select new
                 {
            ...
            query = from a in query
                    join b in context.GetTable<Model_NA.Client>() on a.RizClientId equals b.RizClientId
                    select a;
            result = query.ToList();
            context.Database.ExecuteNonQuery(query.Sql);
            ...
            query = query.Select(a => new Model_NA.Client { RizClientId = a.RizClientId, RizClientName = a.RizClientName, RizQty = a.RizQty }).OrderBy(a => a.RizQty);
            result = query.ToList();
            context.Database.ExecuteNonQuery(query.Sql);
        ...
        protected virtual void Insert()
        {
            ...
            var cQuery = context.GetTable<Model_NA.Client>().Where(x => x.RizClientId <= 100);
            ...
            context.Insert(demo);
            cQuery = context.GetTable<Model_NA.Client>().Where(x => x.RizClientId <= 100);
            context.AddQuery(cQuery);
            context.Insert(demo2);
            context.Update<TDemo>(a => new TDemo
            {
            ...
            List<Model_NA.Client> result1 = null;
            ...
            for (var index = 0; index < 205; index++)
            {
                ...
                if (index == 10)
                {
                    var query2 = context.GetTable<Model_NA.Demo>().Where(x => x.RizDemoId < 100);
            ...
            // 指定ID，默认值支持
            int max = context.GetTable<Model_NA.Client>().Max(x => x.RizClientId);
            context.Delete<Model_NA.Client>(x => x.RizClientId > max);
            context.Delete<Model_NA.Account>(x => x.RizClientId > max);
            context.Delete<Model_NA.Market>(x => x.RizClientId > max);
            context.SubmitChanges();

            Model_NA.Client client = new Model_NA.Client
            {
                RizClientId = max + 1,
                RizClientCode = "ABC",
                RizClientName = "啊啵呲",
            ...
            context.Insert<Model_NA.Client>(client);

            var account = new Model_NA.Account
            {
                RizClientId = max + 1,
                RizAccountId = "1",
                RizAccountCode = "ABC+",
            ...
            var market = new Model_NA.Market
            {
                RizClientId = max + 1,
                RizAccountId = "1",
                RizMarketId = 1,
            ...
            var query =
                ...
                select new Model_NA.Client
                {
                    RizClientId = Data.DbFunctions.RowNumber<int>(a.RizClientId) + (max + 2),
                    RizClientCode = "ABC2",
                    RizClientName = "啊啵呲2",
                    RizCloudServerId = 3,
                    RizState = 2,
            ...
            // 子查询增
            var sum =
                from a in context.GetTable<Model_NA.Account>()
                where a.RizClientId > 0
            ...
            max = context.GetTable<Model_NA.Client>().Max(x => x.RizClientId);
            var nQuery =
                from a in sum
                join b in context.GetTable<Model_NA.Client>() on a.RizClientId equals b.RizClientId into u_b
                from b in u_b.DefaultIfEmpty()
                where b.RizClientId == null
                select new Model_NA.Client
                {
                    RizClientId = Data.DbFunctions.RowNumber<int>(a.RizClientId) + (max + 1),
            ...
            // 指定ID，无自增列批量增加
            max = context.GetTable<Model_NA.Client>().Max(x => x.RizClientId);
            List<Model_NA.Client> clients = new List<Model_NA.Client>();
            for (int index = 0; index < 1002; index++)
            {
                max++;
                client = new Model_NA.Client
                {
                    RizClientId = max,
                ...
                for (var j = 1; j <= 2; j++)
                {
                    var account2 = new Model_NA.Account
                    {
                        RizClientId = max,
                    ...
                    for (int m = 1; m <= 2; m++)
                    {
                        var market2 = new Model_NA.Market
                        {
                            RizClientId = max,
                            RizAccountId = j.ToString(),
                            RizMarketId = m,
            ...
            context.Insert<Model_NA.Client>(clients);
            context.SubmitChanges();
            Debug.Assert(context.GetTable<Model_NA.Client>().Max(x => x.RizClientId) == max);
        ...
        protected virtual void Update()
        {
            ...
            var query =
                ...
                select a;
            context.Update<Model_NA.Client>(a => new
            {
                Qty = -1,
                Remark = a.RizClientCode + "Re'mark"
            }, query);
            context.SubmitChanges();
            var result = context.GetTable<Model_NA.Client>().Where(x => x.CloudServer.RizCloudServerId > 0).ToList();
            // 断言更新成功
            ...
            query =
                from a in context.GetTable<Model_NA.Client>()
                join b in context.GetTable<Model_NA.Server>() on a.RizCloudServerId equals b.RizCloudServerId
                join c in context.GetTable<Model_NA.Account>() on a.RizClientId equals c.RizClientId
                where c.RizAccountId == "1"
                select a;
            context.Update<Model_NA.Client, Model_NA.Server>((a, b) => new Model_NA.Client
            {
                RizCloudServerId = b.RizCloudServerId
            }, query);
            ...
            query =
                ...
                where c.RizAccountId == "1"
                select a;
            context.Update<Model_NA.Client, Model_NA.Server, Model_NA.Account>((a, b, c) => new
            {
            ...
            var uQuery =
               ...
               select a;
            context.Update<Model_NA.Client, Model_NA.Client>((a, b) => new Model_NA.Client
            {
                RizQty = b.RizQty
            }, uQuery);
            //SQL =>
            ...
            var client = context.GetTable<Model_NA.Client>().FirstOrDefault();
        ...
        protected virtual void Delete()
        {
            ...
            // 多主键删除
            var account = context.GetTable<Model_NA.Account>().FirstOrDefault(x => x.RizClientId > 100);
            if (account != null)
            {
            ...
            var query1 =
                context
                .GetTable<Model_NA.Client>()
                .SelectMany(a => context.GetTable<Model_NA.Account>(), (a, b) => a)
                .Where(a => a.RizClientId == 200);
            context.Delete<Model_NA.Client>(query1);
            // 删除不完整的数据
            query1 =
                 from a in context.GetTable<Model_NA.Client>()
                 join b in context.GetTable<Model_NA.Account>() on a.RizClientId equals b.RizClientId into u_b
                 from b in u_b.DefaultIfEmpty()
                 join c in context.GetTable<Model_NA.Market>() on new { b.RizClientId, b.RizAccountId } equals new { c.RizClientId, c.RizAccountId } into u_c
            ...
            query1 =
                from a in context.GetTable<Model_NA.Client>()
                join b in context.GetTable<Model_NA.Account>() on a.RizClientId equals b.RizClientId
                join c in context.GetTable<Model_NA.Market>() on new { b.RizClientId, b.RizAccountId } equals new { c.RizClientId, c.RizAccountId }
            ...
            context.Delete<Model_NA.Client>(a => query3.Contains(a.RizClientId));
            context.SubmitChanges();
            ...
            var query4 =
                ...
                select a;
            context.Delete<Model_NA.Client>(query4);
            context.SubmitChanges();
            ...
            var query5 =
                from a in context.GetTable<Model_NA.Client>()
                join b in context.GetTable<Model_NA.Server>() on a.RizCloudServerId equals b.RizCloudServerId
                join c in context.GetTable<Model_NA.Server>() on a.RizCloudServerId equals c.RizCloudServerId
                join d in subquery on a.RizClientId equals d.RizClientId
                where a.RizClientId > 70 && a.RizCloudServerId > 0
                select a;
            context.Delete<Model_NA.Client>(query5);
            context.SubmitChanges();
            Debug.Assert(query5.Count() == 0);

            // 一次性保存，uow ~~
            context.Delete<TDemo>(x => x.RizDemoId > 100);
            context.Delete<Model_NA.Client>(x => x.RizClientId > 100);
            context.Delete<Model_NA.Account>(x => x.RizClientId > 100);
            context.Delete<Model_NA.Market>(x => x.RizClientId > 100);
            ...
            List<Model_NA.Client> result0 = null;
        ...
        protected virtual void API()
        {
            ...
            var any = context.GetTable<Model_NA.Client>().Any();
            any = context.GetTable<Model_NA.Client>().Any(x => x.RizClientCode.Contains("XF"));

            var count = context.GetTable<Model_NA.Client>().Count();
            count = context.GetTable<Model_NA.Client>().Count(x => x.RizClientCode.Contains("XF"));
#if !net40
            count = context.GetTable<Model_NA.Client>().CountAsync().Result;
            count = context.GetTable<Model_NA.Client>().CountAsync(x => x.RizClientCode.Contains("XF")).Result;
#endif

            var firstOrDefault = context.GetTable<Model_NA.Client>().FirstOrDefault();
            firstOrDefault = context.GetTable<Model_NA.Client>().FirstOrDefault(x => x.RizClientCode.Contains("XF"));
#if !net40
            firstOrDefault = context.GetTable<Model_NA.Client>().FirstOrDefaultAsync(x => x.RizClientCode.Contains("XF")).Result;
#endif

            // 适用于需要产生NULL的场景
            var max = context.GetTable<Model_NA.Client>().Where(a => a.RizClientId == -1).Max(a => (Nullable<int>)a.RizClientId);
            // 适用于不需要产生NULL的场景
            max = context.GetTable<Model_NA.Client>().Where(a => a.RizClientCode.Contains("XF")).Max(a => a.RizClientId);
            // 不需要忽略空值
            max = context.GetTable<Model_NA.Client>().Where(a => a.RizClientCode.Contains("XF")).Max(a => (Nullable<int>)a.RizClientId ?? 0);

            var min = context.GetTable<Model_NA.Client>().Min(a => a.RizClientId);
            min = context.GetTable<Model_NA.Client>().Where(a => a.RizClientCode.Contains("XF")).Min(a => a.RizClientId);

            var avg = context.GetTable<Model_NA.Client>().Average(a => (double)a.RizQty);
            var avg2 = context.GetTable<Model_NA.Client>().Average(a => (decimal)a.RizQty);
            avg = (double)context.GetTable<Model_NA.Client>().Where(a => a.RizClientCode.Contains("XF")).Average(a => (float)a.RizClientId);

            var sum = context.GetTable<Model_NA.Client>().Sum(a => (long)a.RizQty);
            sum = context.GetTable<Model_NA.Client>().Where(a => a.RizClientCode.Contains("XF")).Sum(a => a.RizClientId);

            var toArray = context.GetTable<Model_NA.Client>().ToArray();
            toArray = context.GetTable<Model_NA.Client>().OrderBy(a => a.RizClientId).ToArray(2, 10);

            var dataTalbe = context.GetTable<Model_NA.Client>().ToDataTable();
            var dataSet = context.GetTable<Model_NA.Client>().ToDataSet();
            ...
            context.Update<Model_NA.Client>(x => new Model_NA.Client
            {
                RizClientName = "蒙3"
            }, x => x.RizClientId == 3);
            var query =
            ...
            try
            {
                ...
                {
                    var result = context.GetTable<Model_NA.Client>().FirstOrDefault(x => x.RizClientId <= 10);
                    context.Update<Model_NA.Client>(x => new Model_NA.Client
                    {
                        RizClientName = "事务1"
                    }, x => x.RizClientId == result.RizClientId);
                    context.SubmitChanges();
                    result = context.GetTable<Model_NA.Client>().FirstOrDefault(x => x.RizClientId == result.RizClientId);
