    ...
    public class SqlServerTest : TestBase<SqlServerModel.SqlServerDemo>
    {
        ...
        public override void Run(DatabaseType dbType)
        {
            ...
            var query =
                ...
                join b in context.GetTable<RizSqlServerModel.JoinKey>() on a.ClientId equals b.Key1
                select a;
        ...
        protected override void API()
        {
            ...
            string fileName = new System.IO.DirectoryInfo(AppDomain.CurrentDomain.BaseDirectory).Parent.Parent.FullName + @"\长文本.txt";
