...
namespace Riz.XFramework.UnitTest
{
    public abstract class TestBase<TDemo> : ITest where TDemo : Model.Demo, new()
    {
        ...
        protected virtual void Join()
        {
            ...
            query = query.Where<Model.Client, Model.CloudServer>((a, b) => a.ClientId > 0 && b.CloudServerName != null);
            query = query.Select<Model.Client, Model.CloudServer, Model.Client>((a, b) => new Model.Client
            {
                ClientId = a.ClientId,
            ...
            query =
                context
                .GetTable<Model.Client>()
                .Include(a => a.CloudServer, a => new Model.CloudServer
                {
                    CloudServerId = a.CloudServerId,
                    CloudServerCode = a.CloudServer.CloudServerCode
                });
            ...
            query =
                ...
                .Include(a => a.CloudServer, a => new Model.CloudServer
                {
                    CloudServerId = a.CloudServerId,
                    CloudServerCode = a.CloudServer.CloudServerCode
                }, a => a.CloudServer.CloudServerCode.Contains("188") && true);
            result = query.ToList();
            query =
                context
                .GetTable<Model.Client>()
                ...
                .Include(a => a.Accounts, a => new Model.ClientAccount
                {
            ...
            query =
                ...
                .Include(a => a.Accounts, a => new Model.ClientAccount
                {
                    AccountId = a.Accounts[0].AccountId,
                    AccountCode = a.Accounts[0].AccountCode,
                }, a => a.Accounts[0].AccountName.Contains("2"));
            result = query.ToList();
        ...
        protected virtual void Update()
        {
            ...
            context.Update<TDemo>(x => new TDemo
            {
                ...
                DemoByte = x.DemoByte >= 100 && demo.DemoByte < 126 ? (byte)(x.DemoByte - 1) : (byte)(x.DemoByte + 1)
