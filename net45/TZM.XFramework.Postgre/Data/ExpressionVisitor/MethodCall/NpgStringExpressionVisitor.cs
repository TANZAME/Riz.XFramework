...
namespace TZM.XFramework.Data
{
    ...
    /// 字符串类型方法解析服务
    /// </summary>
    public class NpgStringExpressionVisitor : StringExpressionVisitor
    {
        private ISqlBuilder _builder = null;
        private ExpressionVisitorBase _visitor = null;

        /// <summary>
        /// 实例化 <see cref="NpgStringExpressionVisitor"/> 类的新实例
        /// </summary>
        public NpgStringExpressionVisitor(IDbQueryProvider provider, ExpressionVisitorBase visitor)
