...
namespace ICS.XFramework.UnitTest.Oracle
{
    public class OracleTest : TestBase<OracleModel.OracleDemo>
    {
        ...
        //const string connString = "User Id=c##sa;Password=123456;Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=localhost)(PORT=1521)))(CONNECT_DATA=(SERVICE_NAME=ORCL)))";
        ...
        protected override void API()
        {
            ...
            var demo = new OracleModel.OracleDemo
            {
                ...
                DemoInt = 64,
                DemoLong = 64,
                DemoTime_Nullable = new DateTime(2019, 04, 18, 10, 9, 9),
                DemoDatetimeOffset_Nullable = DateTime.Now,
                DemoTimestamp_Nullable = DateTime.Now,
                DemoText_Nullable = "TEXT 类型",
                DemoNText_Nullable = "NTEXT 类型",
