...
namespace Riz.XFramework.Data.SqlClient
{
    ...
    /// SQL 语句构造器
    /// </summary>
    internal class MySqlDbValueResolver : DbValueResolver
    {
        /// <summary>
        /// SQL字段值解析器实例
        /// </summary>
        public static MySqlDbValueResolver Instance = new MySqlDbValueResolver();

        /// <summary>
        /// 实例化 <see cref="MySqlDbValueResolver"/> 类的新实例
        /// </summary>
        protected MySqlDbValueResolver()
