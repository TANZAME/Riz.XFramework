...
namespace TZM.XFramework.Data
{
    ...
    /// 字符串类型方法解析服务
    /// </summary>
    public class MySqlStringExpressionVisitor : StringExpressionVisitor
    {
        private ISqlBuilder _builder = null;
        private ExpressionVisitorBase _visitor = null;

        /// <summary>
        /// 实例化 <see cref="MySqlStringExpressionVisitor"/> 类的新实例
        /// </summary>
        public MySqlStringExpressionVisitor(IDbQueryProvider provider, ExpressionVisitorBase visitor)
