...
namespace TZM.XFramework.Data
{
    ...
    public partial interface IDatabase
    {
        ...
        Task<int> ExecuteNonQueryAsync(List<RawCommand> sqlList);
        ...
        /// <param name="sqlList">SQL 命令</param>
        /// <returns></returns>
        Task<object> ExecuteScalarAsync(List<RawCommand> sqlList);
        ...
        /// <param name="sqlList">SQL 命令</param>
        /// <returns></returns>
        Task<IDataReader> ExecuteReaderAsync(List<RawCommand> sqlList);
