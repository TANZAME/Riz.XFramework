...
namespace TZM.XFramework.Data
{
    ...
    public partial class FieldAccessor : MemberAccessorBase
    {
        ...
        {
            if (_get == null) _get = FieldAccessor.InitializeGetter(_field);
            return _get(target);
        }
        ...
        {
            if (_set == null) _set = FieldAccessor.InitializeSetter(_field);
        ...
        private static Func<object, object> InitializeGetter(FieldInfo field)
        {
            ...
            var m = new DynamicMethod(string.Empty, returnType, new Type[] { returnType }, declaringType);
        ...
        {
            Type declaringType = field.DeclaringType;
            var m = new DynamicMethod(string.Empty, null, new Type[] { typeof(object), typeof(object) }, declaringType);
            ILGenerator g = m.GetILGenerator();
