...
namespace TZM.XFramework.Data
{
    ...
    /// </summary>
    public partial class TypeDeserializerImpl
    {
        ...
        private void ConvertBox(ILGenerator il, Type from, Type to, Type via)
        {
            ...
            else if (this.ConvertBoxExtension(il, from, to, via))
            {
            }
            else
            {
        ...
        /// <returns></returns>
        protected virtual bool ConvertBoxExtension(ILGenerator il, Type from, Type to, Type via)
        {
            // 内置 Guid 扩展 #######
