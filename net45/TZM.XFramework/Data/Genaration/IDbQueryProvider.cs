...
namespace TZM.XFramework.Data
{
    ...
    public interface IDbQueryProvider
    {
        ...
        /// <returns></returns>
        Command Resolve<T>(IDbQueryable<T> dbQueryable, int indent, bool isOuter, ResolveToken token);
        ...
        /// </summary>
        /// <returns></returns>
        MethodCallExressionVisitor CreateMethodVisitor(ExpressionVisitorBase visitor);
    }
}
